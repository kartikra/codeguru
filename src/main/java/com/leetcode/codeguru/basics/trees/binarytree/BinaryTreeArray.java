...
public class BinaryTreeArray {
    ...
    String[] arr;
    int lastUsedIndex;  // total size allocated vs total size available will always need to be known
    ...
    // Level Order Traversal - only method where we are not using recursion
    ...
    public int search(String value) {
        ...
        System.out.println("The value " + value + " does not exist in binary tree");
        return -1;
    }
